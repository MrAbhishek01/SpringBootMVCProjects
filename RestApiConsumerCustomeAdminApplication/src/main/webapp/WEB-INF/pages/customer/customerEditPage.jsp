...
<body>
    ...
    <nav>
        ...
        <li class="logo"><a href="${pageContext.request.contextPath}/customer/insideCustomerLoginPage">Home</a></li>
            ...
            <li><c:out
					value="Welcome ${sessionScope.loggedInCustomer.firstName}" /> <a href="${pageContext.request.contextPath}/customer/logout">Logout</a></li>
...
<frm:form modelAttribute="customer">
	<table>
		<tr>
			<td><frm:label path="customerUsername">Username</frm:label></td>
			<td><frm:input path="customerUsername" readonly="true" /></td>
		</tr>
		<tr>
			<td><frm:label path="customerPassword">Password</frm:label></td>
